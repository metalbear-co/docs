...
![mirrord - Architecture](/reference/architecture/architecture.svg)
...
However, you can disable any subset of those in the configuration using [agent.disabled_capabilities](/reference/configuration#agent-disabled_capabilities) option.
