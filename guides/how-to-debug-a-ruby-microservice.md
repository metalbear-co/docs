...
Install the mirrord CLI tool and run Guestbook with the required Kubernetes context. Follow the installation guide for [mirrord here](https://metalbear.com/mirrord/docs/getting-started/quick-start#install) and run the command below.
