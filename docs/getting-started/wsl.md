...
![Install Ubuntu from the Microsoft store](/getting-started/wsl/images/ms-store-install-ubuntu.png)

After installation is complete, click on the Open button and a terminal window will appear.

![Open Ubuntu from the Microsoft store](/getting-started/wsl/images/ms-store-open-ubuntu.png)

### From the Terminal 

Open a terminal with **administrator privileges**.

![Open terminal with administrator privileges](/getting-started/wsl/images/open-terminal-administrator.png)
...
![Setting up Ubuntu](/getting-started/wsl/images/setting-up-ubuntu.png)
...
![Linux files from Windows Explorer](/getting-started/wsl/images/linux-files-from-windows-explorer.png)
...
![VS Code remote explorer WSL Targets](/getting-started/wsl/images/vscode-remote-explorer.png)

Select the Linux distro you have set up, and click on the Connect in Current Window button that appears.

![VS Code remote explorer WSL Targets connecting to Ubuntu](/getting-started/wsl/images/vscode-remote-explorer-connect-ubuntu.png)

VS Code will notify you it’s starting WSL, and the Remote Explorer will change to indicate you’re connected.

![VS Code connected to WSL](/getting-started/wsl/images/vscode-connected-wsl.png)

Now go to the Extensions panel, search for mirrord and install it.

![VS Code extensions install mirrord](/getting-started/wsl/images/vscode-install-mirrord.png)
...
![VS Code open project](/getting-started/wsl/images/vscode-open-project.png)
...
![IntelliJ IDEA new window](/getting-started/wsl/images/intellij-new-window.png)

Select the WSL option under Remote Development.

![IntelliJ IDEA select WSL](/getting-started/wsl/images/intellij-select-wsl.png)

Click on the + button (if you already have a project, otherwise select New Project).

![IntelliJ IDEA open WSL project](/getting-started/wsl/images/intellij-open-wsl-project.png)
...
![IntelliJ IDEA find project in WSL path](/getting-started/wsl/images/intellij-wsl-project-path.png)

Now click `Download IDE and Connect` at the bottom.

![IntelliJ IDEA download and connect to WSL IDE](/getting-started/wsl/images/intellij-download-and-connect.png)

The IDE will be downloaded and installed on Linux. After it’s ready, it should automatically open.

![IntelliJ IDEA project is open on WSL](/getting-started/wsl/images/intellij-wsl-project.png)

Click on the gear button, select `Plugins` and search the `Marketplace` for “mirrord”.

![IntelliJ IDEA WSL install mirrord from marketplace](/getting-started/wsl/images/intellij-install-mirrord.png)
...
![IntelliJ IDEA restart WSL IDE after installing mirrord](/getting-started/wsl/images/intellij-restart-wsl-ide.png)
