...
**Working with an AI coding agent?** It can start a seven-day trial itself, without an account or a credit card, and hand you a link to claim it afterwards. See [Agent-Started Trials](../using-mirrord-with-ai/agent-started-trials.md).
{% endhint %}
