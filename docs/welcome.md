...
Not just developers but AI coding tools like Claude Code, Cursor, Codex, etc. can [use mirrord](./using-mirrord-with-ai/README.md) as well to safely test generated code against real cluster services, catching integration issues early, and iterating until the code works end-to-end.
