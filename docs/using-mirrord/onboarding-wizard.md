...
{% hint style="info" %}
This feature is still young! Please be aware that there may be bugs and strange behaviour, and there maybe be significant changes as the feature is developed.
{% endhint %}
...
Here, you can configure specific ports that you are interested in mirrord or stealing. Ports that are exposed in the resource definition of your target will be added automatically, but you can remove these or add your own.
...
Preview and download (or copy to clipboard) the configuration file according to the options you have set in the previous steps.