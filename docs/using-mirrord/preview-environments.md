...
![How mirrord Preview Environments work](/docs/using-mirrord/preview-envs/images/preview-envs-diagram.png)
...
```json
{
  ...
  "feature": {
    "preview": {
      ...
      "ttl_mins": 120 // set to `"infinite"` to have the session live until being manually stopped
    },
    "network": {
      "incoming": {
        "mode": "steal",
