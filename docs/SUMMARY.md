...
* [Setup & IDEs](setup/README.md)
  * [Install & Run via CLI](setup/install-cli.md)
...
* [Using mirrord](using-mirrord/README.md)
  * [Test staging locally](using-mirrord/test-staging-locally.md)
    * [Networking](using-mirrord/networking.md)
    * [Environment variables](using-mirrord/environment-variables.md)
    * [File system](using-mirrord/file-system.md)
