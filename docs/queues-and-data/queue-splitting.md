...
2. Running your application with [`copy_target` + `scale_down`](../mirrord-for-teams/copy-target.md#replacing-a-whole-deployment-using-scale_down) will result in the deployed application not consuming any messages, and your local application being the exclusive consumer of queue messages.
