...
2. Running your application with [`copy_target` + `scale_down`](../working-as-a-team/copy-target.md#replacing-a-whole-deployment-using-scale_down) will result in the deployed application not consuming any messages, and your local application being the exclusive consumer of queue messages.
