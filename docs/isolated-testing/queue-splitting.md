...
tags:
  - team
  - enterprise
description: Share queues safely by splitting messages between multiple developers using filters
---
...
2. Running your application with [`copy_target` + `scale_down`](../targeting-modes/clone-remote-pod.md#replacing-a-whole-deployment-using-scale_down) will result in the deployed application not consuming any messages, and your local application being the exclusive consumer of queue messages.
