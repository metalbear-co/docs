...
menu:
  docs:
    parent: managing-the-operator
weight: 100
toc: true
tags:
  - team
  - enterprise
description: Configure Operator logging and expose metrics to monitor mirrord usage
---
...
Download it [here](https://github.com/metalbear-co/docs/tree/main/docs/managing-the-operator/assets/Mirrord_datadog_Operator_Dashboard.json)

## Grafana Dashboard

Alternatively there is a Grafana dashboard you can import to track statistics.

Download it [here](https://github.com/metalbear-co/docs/tree/main/docs/managing-the-operator/assets/Mirrord_grafana_Operator_Dashboard.json)
...
Download it [here](https://github.com/metalbear-co/docs/tree/main/docs/managing-the-operator/assets/operator-fluentd-kibana.ndjson) (use Saved Objects to import).
