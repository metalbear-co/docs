...
tags:
  - team
  - enterprise
description: Understand the Operator's security model and configure RBAC and TLS
---
...
You can define [policies](../sharing-the-cluster/test-concurrently-safely.md) that prevent stealing (or only prevent stealing without setting a filter) and/or mirroring for selected targets. Let us know if there are more features you would like to be able to limit using policies.
