...
[`feature.split_queues`](https://metalbear.com/mirrord/docs/config#feature.split_queues) is the configuration field they need to specify in order to filter queue messages.
