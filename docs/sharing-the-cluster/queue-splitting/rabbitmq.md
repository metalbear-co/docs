...
2. The cluster connection parameters are defined in the `meme-rmq-cluster` `MirrordPropertyList`, looked up in the same namespace as this config (`meme`) and then in the operator's namespace.
