...
1. If you'd like to intercept traffic rather than mirror it so that your local process is the one answering the remote requests, check out [this guide](traffic-filtering.md). Note that you can even filter which traffic you intercept!
